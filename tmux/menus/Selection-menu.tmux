...
set -s @_title   "#[bold align=centre]      FILE  EDIT  PACKAGES  VIEW  #[fg=colour30]SELECTION #[default bold fg=colour248]     "
...
""                                          \
"#[bold fg=colour30] Prev Menu  #{@_arrL}" C-h 'source ~/Projects/dotfiles/tmux/menus/View-menu.tmux' \
