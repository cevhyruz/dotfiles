...
set -s @_title   "#[bold align=centre]      FILE#[fg=colour30]  EDIT#[default bold fg=colour248]  PACKAGES  VIEW  SELECTION      "
...
""                                         \
"#[bold fg=colour30] Prev Menu  #{@_arrL}" C-h 'source ~/Projects/dotfiles/tmux/menus/File-menu.tmux'     \
"#[bold fg=colour30] Next Menu  #{@_arrR}" C-l 'source ~/Projects/dotfiles/tmux/menus/Packages-menu.tmux' \
